...
plt.grid()
plt.xlabel(r"$\omega$")
plt.ylabel(r"$x_{\rm max}$")
plt.title(r"Resonance Curve. $\alpha = 0, \beta = 2.0, \gamma = 1.0, \delta = 0.25, \Delta t = 0.01, t_{\rm max} = 1000$")
...
plt.grid()
plt.xlabel(r"$\omega$")
plt.ylabel(r"$|x_{\rm max}^{\rm num} - x_{\rm max}^{\rm ana}|$")
plt.title(r"Differences. $\alpha = 0, \beta = 2.0, \gamma = 1.0, \delta = 0.25, \Delta t = 0.01, t_{\rm max} = 1000$")
